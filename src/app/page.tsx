...
export default function AIPlaygroundPage() {
  ...
  return (
    <main className="min-h-screen flex flex-col bg-[#07090e] cyber-grid relative overflow-hidden">
      ...
      <header className="px-4 py-2.5 bg-slate-950/90 border-b border-slate-800/80 backdrop-blur-md flex items-center justify-between z-10">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[11px] text-slate-400 font-mono hidden sm:block">
              11 Realistic Political Figures &bull; Single 9router Custom Endpoint &bull; Elimination Reality Format
            </p>
          </div>
        </div>

        {/* Current Round Indicator & Quick Settings Button */}
